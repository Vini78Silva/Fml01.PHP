...
<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&display=swap" rel="stylesheet">
    <title>Cadastre um funcionario</title>
    <style>
        nav {
    width: 100%;
    ...
    <form action="insertFuncionario.php" method="POST">
        <div class="container">
            ...
            <div class="inps">
                ...
                <div class="i1">
                    <input type="text" id="nome" name="nomeFuncionario" placeholder="Nome:" required>
                    <input type="text" id="sobrenome" name="sobrenomeFuncionario" placeholder="Sobrenome:" required>
                </div>
                
    
    
                <div class="i2">
                    <input type="text" id="dt_nascimento" name="dtNascimento" placeholder="Nascimento: dd/mm/aa" required>
                    <input type="text" id="cargo" name="cargo" placeholder="cargo:" required>
                </div>
                
    
                <div class="i3">
                    <input type="number" id="salario" name="salario" placeholder="salário:" required>
                    <input type="text" id="dt_admissao" name="dtAdmissao" placeholder="Adimissao: dd/mm/aa" required>
                </div>
    
                <div class="i4">
                    <input type="password"  placeholder="senha:" required>
                    <input type="password" id="senha" name="senha" placeholder="confirmar senha:" required>
                </div>
